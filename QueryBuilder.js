 ...
 *
 * @class Jii.mysql.QueryBuilder
 * @extends Jii.data.QueryBuilder
 */
var QueryBuilder = Jii.defineClass('Jii.mysql.QueryBuilder', /** @lends Jii.mysql.QueryBuilder.prototype */{

	__extends: BaseQueryBuilder,
